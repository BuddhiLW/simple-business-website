...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(insert_fn,zloc,(cljs.core.truth_((function (){var or__5045__auto__ = cljs.core.not(next_node);
if(or__5045__auto__){
...
return rewrite_clj.zip.insert.insert((function (p1__39250_SHARP_){
var G__39251 = p1__39250_SHARP_;
var G__39251__$1 = (((G__39251 == null))?null:clojure.zip.down(G__39251));
if((G__39251__$1 == null)){
return null;
} else {
return clojure.zip.rightmost(G__39251__$1);
}
