...
var G__50449 = request;
var G__50450 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__50449,G__50450) : ajax.formats.get_format.call(null,G__50449,G__50450));
} else {
...
return cljs.core.some((function (p1__50453_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__50453_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__50460){
var map__50461 = p__50460;
var map__50461__$1 = cljs.core.__destructure_map(map__50461);
var request = map__50461__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50461__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__50465 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__50465.cljs$core$IFn$_invoke$arity$1 ? fexpr__50465.cljs$core$IFn$_invoke$arity$1(response) : fexpr__50465.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__50467){
var map__50468 = p__50467;
var map__50468__$1 = cljs.core.__destructure_map(map__50468);
var request = map__50468__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50468__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__50466_SHARP_){
return ajax.formats.get_accept_entries(request,p1__50466_SHARP_);
