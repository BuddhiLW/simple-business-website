...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38444,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38453 = k38444;
var G__38453__$1 = (((G__38453 instanceof cljs.core.Keyword))?G__38453.fqn:null);
switch (G__38453__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38444,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38455){
var vec__38456 = p__38455;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38456,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38456,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38443){
var self__ = this;
var G__38443__$1 = this;
return (new cljs.core.RecordIter((0),G__38443__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38445,other38446){
var self__ = this;
var this38445__$1 = this;
return (((!((other38446 == null)))) && ((((this38445__$1.constructor === other38446.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.tag,other38446.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.wrap_fn,other38446.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.wrap_length,other38446.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.seq_fn,other38446.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.children,other38446.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38445__$1.__extmap,other38446.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38524 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__38524) : self__.seq_fn.call(null,G__38524));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38529 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__38529) : self__.wrap_fn.call(null,G__38529));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38444){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38540 = k38444;
var G__38540__$1 = (((G__38540 instanceof cljs.core.Keyword))?G__38540.fqn:null);
switch (G__38540__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38443){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38545 = cljs.core.keyword_identical_QMARK_;
var expr__38546 = k__5352__auto__;
if(cljs.core.truth_((pred__38545.cljs$core$IFn$_invoke$arity$2 ? pred__38545.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38546) : pred__38545.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38546)))){
return (new rewrite_clj.node.seq.SeqNode(G__38443,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38545.cljs$core$IFn$_invoke$arity$2 ? pred__38545.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38546) : pred__38545.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38546)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__38443,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38545.cljs$core$IFn$_invoke$arity$2 ? pred__38545.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38546) : pred__38545.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38546)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__38443,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38545.cljs$core$IFn$_invoke$arity$2 ? pred__38545.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38546) : pred__38545.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38546)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__38443,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38545.cljs$core$IFn$_invoke$arity$2 ? pred__38545.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38546) : pred__38545.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38546)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__38443,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38443),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38443){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__38443,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__38451){
var extmap__5385__auto__ = (function (){var G__38585 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38451,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__38451),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__38451),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__38451),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__38451),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38451),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__38590_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__38590_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__38599_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__38599_SHARP_);
}),children);
});
