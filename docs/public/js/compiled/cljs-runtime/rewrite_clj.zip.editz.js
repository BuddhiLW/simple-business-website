...
var G__39266 = (function (){var G__39267 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__39267) : f.call(null,G__39267));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__39266) : rewrite_clj.node.coerce.call(null,G__39266));
});
/**
...
var len__5769__auto___39303 = arguments.length;
var i__5770__auto___39304 = (0);
while(true){
if((i__5770__auto___39304 < len__5769__auto___39303)){
args__5775__auto__.push((arguments[i__5770__auto___39304]));

var G__39305 = (i__5770__auto___39304 + (1));
i__5770__auto___39304 = G__39305;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__39269_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__39269_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq39270){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39271,G__39272,seq39270__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__39279 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__39279) : str_fn.call(null,G__39279));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__39281 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__39281) : str_fn.call(null,G__39281));
})()):null)));
...
var G__39286 = rewrite_clj.zip.base.tag(zloc);
var G__39286__$1 = (((G__39286 instanceof cljs.core.Keyword))?G__39286.fqn:null);
switch (G__39286__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__39282_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39282_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__39284_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39284_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39286__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__39298 = rewrite_clj.zip.base.tag(zloc);
var G__39298__$1 = (((G__39298 instanceof cljs.core.Keyword))?G__39298.fqn:null);
switch (G__39298__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__39288_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39288_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39298__$1)].join('')));
