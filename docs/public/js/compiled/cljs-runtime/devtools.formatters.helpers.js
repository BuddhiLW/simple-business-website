...
var G__28721 = devtools.prefs.pref(v);
v = G__28721;
continue;
} else {
return v;
...
}catch (e28678){var _e__27782__auto__ = e28678;
return false;
}})();
...
}catch (e28680){var _e__27782__auto__ = e28680;
return false;
}})();
...
}catch (e28682){var _e__27782__auto__ = e28682;
return false;
}}
}
});
...
var vec__28693 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28693,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28693,(1),null);
...
return cljs.core.some((function (p1__28699_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28699_SHARP_);
}),template);
});
