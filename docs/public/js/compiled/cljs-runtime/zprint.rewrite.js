...
var G__40140 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__40140;
continue;
} else {
var G__40141 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40141;
continue;
}
} else {
var G__40143 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40143;
continue;
}
}
...
var G__40082 = zloc;
var G__40083 = (function (){var G__40084 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__40087 = zloc;
var G__40087__$1 = (((G__40087 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__40087) : rewrite_clj.zip.node.call(null,G__40087)));
if((G__40087__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40087__$1) : zprint.zutil.edn_STAR_.call(null,G__40087__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__40084) : rewrite_clj.zip.root.call(null,G__40084));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__40082,G__40083) : rewrite_clj.zip.replace.call(null,G__40082,G__40083));
});
/**
...
var G__40149 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__40149;
continue;
}
break;
...
var G__40150 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__40151 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__40150;
out = G__40151;
continue;
} else {
...
var G__40158 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__40159 = cljs.core.next(new_loc);
var G__40160 = replaced_loc;
nloc = G__40158;
new_loc = G__40159;
last_loc = G__40160;
continue;
...
return zprint.rewrite.sort_val((function (){var G__40102 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__40102) : rewrite_clj.zip.down.call(null,G__40102));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__40104_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__40104_SHARP_) : rewrite_clj.zip.tag.call(null,p1__40104_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__40104_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__40104_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
