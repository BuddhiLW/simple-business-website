...
var syms = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__38432(s__38433){
return (new cljs.core.LazySeq(null,(function (){
var s__38433__$1 = s__38433;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__38433__$1);
if(temp__5804__auto__){
var s__38433__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38433__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__38433__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__38435 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__38434 = (0);
while(true){
if((i__38434 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__38434);
...
cljs.core.chunk_append(b__38435,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__38558 = (i__38434 + (1));
i__38434 = G__38558;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38435),rewrite_clj$node$fn$fn_walk_$_iter__38432(cljs.core.chunk_rest(s__38433__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38435),null);
}
} else {
var i = cljs.core.first(s__38433__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__38432(cljs.core.rest(s__38433__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__38430_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__38430_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__38430_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38448,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38454 = k38448;
var G__38454__$1 = (((G__38454 instanceof cljs.core.Keyword))?G__38454.fqn:null);
switch (G__38454__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38448,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38459){
var vec__38460 = p__38459;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38460,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38460,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38447){
var self__ = this;
var G__38447__$1 = this;
return (new cljs.core.RecordIter((0),G__38447__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38449,other38450){
var self__ = this;
var this38449__$1 = this;
return (((!((other38450 == null)))) && ((((this38449__$1.constructor === other38450.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.children,other38450.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.__extmap,other38450.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38448){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38448);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38447){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38508 = cljs.core.keyword_identical_QMARK_;
var expr__38509 = k__5352__auto__;
if(cljs.core.truth_((pred__38508.cljs$core$IFn$_invoke$arity$2 ? pred__38508.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38509) : pred__38508.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38509)))){
return (new rewrite_clj.node.fn.FnNode(G__38447,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38447),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38447){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__38447,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__38452){
var extmap__5385__auto__ = (function (){var G__38530 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38452,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__38452)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38530);
} else {
return G__38530;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38452),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
