...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38379,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38388 = k38379;
var G__38388__$1 = (((G__38388 instanceof cljs.core.Keyword))?G__38388.fqn:null);
switch (G__38388__$1) {
case "whitespace":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38379,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38391){
var vec__38392 = p__38391;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38392,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38392,(1),null);
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38378){
var self__ = this;
var G__38378__$1 = this;
return (new cljs.core.RecordIter((0),G__38378__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38380,other38381){
var self__ = this;
var this38380__$1 = this;
return (((!((other38381 == null)))) && ((((this38380__$1.constructor === other38381.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38380__$1.whitespace,other38381.whitespace)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38380__$1.__extmap,other38381.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38379){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38379);

}
}));

(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38378){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38413 = cljs.core.keyword_identical_QMARK_;
var expr__38414 = k__5352__auto__;
if(cljs.core.truth_((pred__38413.cljs$core$IFn$_invoke$arity$2 ? pred__38413.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__38414) : pred__38413.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__38414)))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__38378,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38378),null));
}
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38378){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__38378,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__38385){
var extmap__5385__auto__ = (function (){var G__38431 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38385,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483));
if(cljs.core.record_QMARK_(G__38385)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38431);
} else {
return G__38431;
}
})();
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__38385),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38437,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38477 = k38437;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38437,else__5346__auto__);
...
var self__ = this;
var this__5363__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38478){
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38436){
var self__ = this;
var G__38436__$1 = this;
return (new cljs.core.RecordIter((0),G__38436__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38438,other38439){
var self__ = this;
var this38438__$1 = this;
return (((!((other38439 == null)))) && ((((this38438__$1.constructor === other38439.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38438__$1.newlines,other38439.newlines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38438__$1.__extmap,other38439.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38437){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38516 = k38437;
var G__38516__$1 = (((G__38516 instanceof cljs.core.Keyword))?G__38516.fqn:null);
switch (G__38516__$1) {
case "newlines":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38437);

}
}));

(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38436){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38520 = cljs.core.keyword_identical_QMARK_;
var expr__38521 = k__5352__auto__;
if(cljs.core.truth_((pred__38520.cljs$core$IFn$_invoke$arity$2 ? pred__38520.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__38521) : pred__38520.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__38521)))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__38436,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38436),null));
}
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38436){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__38436,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__38442){
var extmap__5385__auto__ = (function (){var G__38539 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38442,new cljs.core.Keyword(null,"newlines","newlines",-1185451518));
if(cljs.core.record_QMARK_(G__38442)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38539);
} else {
return G__38539;
}
})();
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__38442),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var comma_38672 = rewrite_clj.node.whitespace.whitespace_node(", ");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(comma_38672)));
});
var nl_38675 = rewrite_clj.node.whitespace.newline_node("\n");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(nl_38675)));
});
var space_38677 = rewrite_clj.node.whitespace.whitespace_node(" ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(space_38677)));
});
/**
