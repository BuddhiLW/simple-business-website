...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37934_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37934_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37934_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37937){
var vec__37938 = p__37937;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37938,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37938,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37943,s,color,element,idx){
var map__37949 = p__37943;
var map__37949__$1 = cljs.core.__destructure_map(map__37949);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37949__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37949__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37949__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37962 = (function (){var or__5045__auto__ = color;
...
var fexpr__37961 = (function (){var G__37963 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37963) : style_map.call(null,G__37963));
})();
return (fexpr__37961.cljs$core$IFn$_invoke$arity$1 ? fexpr__37961.cljs$core$IFn$_invoke$arity$1(G__37962) : fexpr__37961.call(null,G__37962));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37965){
var vec__37966 = p__37965;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37966,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37966,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37966,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37969){
var vec__37970 = p__37969;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37970,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37970,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37970,(2),null);
...
var G__38160 = cljs.core.next(ssv);
var G__38161 = (this_ssv == null);
var G__38162 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__38163 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__38160;
doing_nil_QMARK_ = G__38161;
last_elide = G__38162;
out = G__38163;
continue;
}
...
var vec__37998 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37998,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37998,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37998,(2),null);
...
var G__38166 = cljs.core.next(remaining_cvec);
var G__38167 = new_idx;
var G__38168 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__38166;
idx = G__38167;
out = G__38168;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__38030,cursor_vec){
var vec__38032 = p__38030;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(1),null);
var focus_vec = vec__38032;
...
var vec__38035 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38035,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38035,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__38039){
var vec__38040 = p__38039;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38040,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38040,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__38053,existing_count){
var vec__38056 = p__38053;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38056,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38056,(1),null);
...
return cljs.core.filterv((function (p1__38049_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__38049_SHARP_))));
...
var vec__38078 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38078,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38078,(1),null);
var cvec_element = vec__38078;
if((cvec_element == null)){
var G__38199 = cljs.core.next(cvec_nl);
var G__38200 = (idx + (1));
var G__38201 = start;
var G__38202 = out;
cvec_nl = G__38199;
...
var G__38203 = cljs.core.next(cvec_nl);
var G__38204 = (idx + (1));
var G__38205 = idx;
var G__38206 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__38203;
idx = G__38204;
start = G__38205;
out = G__38206;
...
var G__38208 = cljs.core.next(cvec_nl);
var G__38209 = (idx + (1));
var G__38210 = (idx + (1));
var G__38211 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__38208;
idx = G__38209;
start = G__38210;
out = G__38211;
...
var G__38212 = cljs.core.next(cvec_nl);
var G__38213 = (idx + (1));
var G__38214 = idx;
var G__38215 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__38212;
idx = G__38213;
start = G__38214;
out = G__38215;
...
var G__38216 = cljs.core.next(cvec_nl);
var G__38217 = (idx + (1));
var G__38218 = start;
var G__38219 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__38216;
idx = G__38217;
start = G__38218;
out = G__38219;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__38085_SHARP_,p2__38084_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__38084_SHARP_)){
return cljs.core.reduced(p1__38085_SHARP_);
} else {
return (p1__38085_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__38098,p__38099){
var vec__38100 = p__38098;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38100,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38100,(1),null);
var vec__38103 = p__38099;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38103,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38103,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__38129,cvec,focus_vec){
var map__38130 = p__38129;
var map__38130__$1 = cljs.core.__destructure_map(map__38130);
var options = map__38130__$1;
var map__38131 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38130__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__38131__$1 = cljs.core.__destructure_map(map__38131);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38131__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38131__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38131__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38125_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__38125_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
