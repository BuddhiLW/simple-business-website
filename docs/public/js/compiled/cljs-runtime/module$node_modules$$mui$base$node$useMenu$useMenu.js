...
void 0:null==(_subitems$get2$ref$cu=_subitems$get2.ref.current)?void 0:_subitems$get2$ref$cu.focus()}},[onOpenChange,subitems]),{dispatch,getRootProps,contextValue:listContextValue,state:{open,highlightedValue},rootRef:mergedListRef}=(0,_useList.default)({controlledProps,disabledItemsFocusable:!0,focusManagement:"DOM",getItemDomElement,getInitialState:()=>({selectedValues:[],highlightedValue:null,open:null!=defaultOpen?defaultOpen:!1}),isItemDisabled:id=>{var _subitems$get3;return(null==subitems?
void 0:null==(_subitems$get3=subitems.get(id))?void 0:_subitems$get3.disabled)||!1},items:subitemKeys,getItemAsString:id=>{var _subitems$get4,_subitems$get5,_subitems$get5$ref$cu;return(null==(_subitems$get4=subitems.get(id))?void 0:_subitems$get4.label)||(null==(_subitems$get5=subitems.get(id))?void 0:null==(_subitems$get5$ref$cu=_subitems$get5.ref.current)?void 0:_subitems$get5$ref$cu.innerText)},rootRef:parameters,onStateChange:stateChangeHandler,reducerActionContext:{listboxRef},selectionMode:"none",
stateReducer:_menuReducer.default});React.useEffect(()=>{if(open&&highlightedValue===subitemKeys[0]){var _subitems$get6,_subitems$get6$ref,_subitems$get6$ref$cu;null==(_subitems$get6=subitems.get(subitemKeys[0]))?void 0:null==(_subitems$get6$ref=_subitems$get6.ref)?void 0:null==(_subitems$get6$ref$cu=_subitems$get6$ref.current)?void 0:_subitems$get6$ref$cu.focus()}},[open,highlightedValue,subitems,subitemKeys]);React.useEffect(()=>{var _listboxRef$current;if(null!=(_listboxRef$current=listboxRef.current)&&
_listboxRef$current.contains(document.activeElement)&&null!==highlightedValue){var _subitems$get7,_subitems$get7$ref$cu;null==subitems?void 0:null==(_subitems$get7=subitems.get(highlightedValue))?void 0:null==(_subitems$get7$ref$cu=_subitems$get7.ref.current)?void 0:_subitems$get7$ref$cu.focus()}},[highlightedValue,subitems]);React.useDebugValue({subitems,highlightedValue});return{contextValue:(0,_extends2.default)({},compoundComponentContextValue,listContextValue),dispatch,getListboxProps:(otherHandlers=
{})=>{const rootProps=getRootProps(otherHandlers);return(0,_extends2.default)({},otherHandlers,rootProps,{role:"menu"})},highlightedValue,listboxRef:mergedListRef,menuItems:subitems,open}};var _extends2=global(require("module$node_modules$$babel$runtime$helpers$extends")),React=function(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule)return obj;if(null===obj||"object"!==typeof obj&&"function"!==typeof obj)return{default:obj};if((nodeInterop=_getRequireWildcardCache(nodeInterop))&&nodeInterop.has(obj))return nodeInterop.get(obj);
...
_useList=global(require("module$node_modules$$mui$base$node$useList$index")),_useCompound=require("module$node_modules$$mui$base$node$utils$useCompound"),_menuReducer=global(require("module$node_modules$$mui$base$node$useMenu$menuReducer"))}
