...
var o__27763__auto___28803 = (function (){var o__27763__auto___28803 = (function (){var o__27763__auto___28803 = Promise;
return (o__27763__auto___28803["resolve"]).call(o__27763__auto___28803);
})();
return (o__27763__auto___28803["then"]).call(o__27763__auto___28803,callback);
})();
(o__27763__auto___28803["catch"]).call(o__27763__auto___28803,devtools.async.rethrow_outside_promise);
...
var G__28796_28804 = Error;
var target__27772__auto___28805 = G__28796_28804;
if(cljs.core.truth_(target__27772__auto___28805)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28796_28804)].join(''),"\n","target__27772__auto__"].join('')));
}

(target__27772__auto___28805["stackTraceLimit"] = Infinity);
