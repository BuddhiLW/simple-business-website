...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38281,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38298 = k38281;
var G__38298__$1 = (((G__38298 instanceof cljs.core.Keyword))?G__38298.fqn:null);
switch (G__38298__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38281,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38337){
var vec__38338 = p__38337;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38338,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38338,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38280){
var self__ = this;
var G__38280__$1 = this;
return (new cljs.core.RecordIter((0),G__38280__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38282,other38283){
var self__ = this;
var this38282__$1 = this;
return (((!((other38283 == null)))) && ((((this38282__$1.constructor === other38283.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38282__$1.tag,other38283.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38282__$1.prefix,other38283.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38282__$1.sym,other38283.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38282__$1.children,other38283.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38282__$1.__extmap,other38283.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38281){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38368 = k38281;
var G__38368__$1 = (((G__38368 instanceof cljs.core.Keyword))?G__38368.fqn:null);
switch (G__38368__$1) {
case "tag":
case "prefix":
case "sym":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38281);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38280){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38369 = cljs.core.keyword_identical_QMARK_;
var expr__38370 = k__5352__auto__;
if(cljs.core.truth_((pred__38369.cljs$core$IFn$_invoke$arity$2 ? pred__38369.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38370) : pred__38369.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38370)))){
return (new rewrite_clj.node.quote.QuoteNode(G__38280,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38369.cljs$core$IFn$_invoke$arity$2 ? pred__38369.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__38370) : pred__38369.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__38370)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__38280,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38369.cljs$core$IFn$_invoke$arity$2 ? pred__38369.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__38370) : pred__38369.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__38370)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__38280,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38369.cljs$core$IFn$_invoke$arity$2 ? pred__38369.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38370) : pred__38369.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38370)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__38280,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38280),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38280){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__38280,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__38294){
var extmap__5385__auto__ = (function (){var G__38387 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38294,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__38294)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38387);
} else {
return G__38387;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__38294),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__38294),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__38294),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38294),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__38416 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38416;
continue;
}
break;
...
var G__38417 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38417;
continue;
}
break;
...
var G__38418 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38418;
continue;
}
break;
...
var G__38419 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38419;
continue;
}
break;
