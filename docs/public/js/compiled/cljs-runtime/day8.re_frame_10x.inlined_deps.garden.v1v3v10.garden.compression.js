 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__32833){
var vec__32834 = p__32833;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32834,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32834,(1),null);
return (function (s){
...
return (function (s){
return cljs.core.some((function (p1__32837_SHARP_){
return (p1__32837_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__32837_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__32837_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq32838){
...
var map__32847 = temp__5802__auto__;
var map__32847__$1 = cljs.core.__destructure_map(map__32847);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32847__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32847__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32847__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__32902 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__32903 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__32853 = tag;
