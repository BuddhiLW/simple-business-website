...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38088,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38107 = k38088;
var G__38107__$1 = (((G__38107 instanceof cljs.core.Keyword))?G__38107.fqn:null);
switch (G__38107__$1) {
case "s":
return self__.s;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38088,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38110){
var vec__38111 = p__38110;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38111,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38111,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38087){
var self__ = this;
var G__38087__$1 = this;
return (new cljs.core.RecordIter((0),G__38087__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38089,other38090){
var self__ = this;
var this38089__$1 = this;
return (((!((other38090 == null)))) && ((((this38089__$1.constructor === other38090.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38089__$1.s,other38090.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38089__$1.__extmap,other38090.__extmap)))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38088){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38155 = k38088;
var G__38155__$1 = (((G__38155 instanceof cljs.core.Keyword))?G__38155.fqn:null);
switch (G__38155__$1) {
case "s":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38088);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38087){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38156 = cljs.core.keyword_identical_QMARK_;
var expr__38157 = k__5352__auto__;
if(cljs.core.truth_((pred__38156.cljs$core$IFn$_invoke$arity$2 ? pred__38156.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__38157) : pred__38156.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__38157)))){
return (new rewrite_clj.node.comment.CommentNode(G__38087,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38087),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38087){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__38087,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__38096){
var extmap__5385__auto__ = (function (){var G__38178 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38096,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__38096)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38178);
} else {
return G__38178;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__38096),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
