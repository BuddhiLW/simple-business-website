...
var i_43243 = (0);
while(true){
if((i_43243 < arr.length)){
(arr[i_43243] = null);

var G__43244 = (i_43243 + (1));
i_43243 = G__43244;
continue;
} else {
}
...
var i_43251 = (self__.level + (1));
while(true){
if((i_43251 <= (new_level + (1)))){
(update[i_43251] = self__.header);

var G__43252 = (i_43251 + (1));
i_43251 = G__43252;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43253 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43253[i]));
} else {
x__$2.forward.push((((i < links_43253.length))?(links_43253[i]):null));
}

if((i < links_43253.length)){
(links_43253[i] = x__$2);
} else {
links_43253.push(x__$2);
}
...
var i_43256 = (0);
while(true){
if((i_43256 <= self__.level)){
var links_43258 = (update[i_43256]).forward;
if((x__$1 === (((i_43256 < links_43258.length))?(links_43258[i_43256]):null))){
(links_43258[i_43256] = (x__$1.forward[i_43256]));

var G__43259 = (i_43256 + (1));
i_43256 = G__43259;
continue;
} else {
var G__43260 = (i_43256 + (1));
i_43256 = G__43260;
continue;
}
} else {
...
var G__43264 = nx;
var G__43265 = (level__$1 - (1));
x = G__43264;
level__$1 = G__43265;
continue;
} else {
var G__43266 = x;
var G__43267 = (level__$1 - (1));
x = G__43266;
level__$1 = G__43267;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43269 = nx;
var G__43270 = (level__$1 - (1));
x = G__43269;
level__$1 = G__43270;
continue;
} else {
var G__43271 = x;
var G__43272 = (level__$1 - (1));
x = G__43271;
level__$1 = G__43272;
continue;
}
