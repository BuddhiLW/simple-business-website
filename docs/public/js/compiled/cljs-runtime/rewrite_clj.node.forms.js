...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38116,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38116,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38140){
var vec__38145 = p__38140;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38145,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38145,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38115){
var self__ = this;
var G__38115__$1 = this;
return (new cljs.core.RecordIter((0),G__38115__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38117,other38118){
var self__ = this;
var this38117__$1 = this;
return (((!((other38118 == null)))) && ((((this38117__$1.constructor === other38118.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38117__$1.children,other38118.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38117__$1.__extmap,other38118.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38116){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38116);

}
}));

(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38115){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38233 = cljs.core.keyword_identical_QMARK_;
var expr__38255 = k__5352__auto__;
if(cljs.core.truth_((pred__38233.cljs$core$IFn$_invoke$arity$2 ? pred__38233.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38255) : pred__38233.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38255)))){
return (new rewrite_clj.node.forms.FormsNode(G__38115,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38115),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38115){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__38115,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__38124){
var extmap__5385__auto__ = (function (){var G__38269 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38124,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__38124)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38269);
} else {
return G__38269;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38124),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
