...
var G__38981 = clojure.zip.node(loc);
var fexpr__38980 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38980.cljs$core$IFn$_invoke$arity$1 ? fexpr__38980.cljs$core$IFn$_invoke$arity$1(G__38981) : fexpr__38980.call(null,G__38981));
});
/**
...
var G__38985 = clojure.zip.node(loc);
var fexpr__38984 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38984.cljs$core$IFn$_invoke$arity$1 ? fexpr__38984.cljs$core$IFn$_invoke$arity$1(G__38985) : fexpr__38984.call(null,G__38985));
} else {
...
var fexpr__38996 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38996.cljs$core$IFn$_invoke$arity$2 ? fexpr__38996.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__38996.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__38997 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38997,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38997,(1),null);
var vec__39000 = clojure.zip.children(loc);
var seq__39001 = cljs.core.seq(vec__39000);
var first__39002 = cljs.core.first(seq__39001);
var seq__39001__$1 = cljs.core.next(seq__39001);
var c = first__39002;
var cnext = seq__39001__$1;
var cs = vec__39000;
...
var vec__39007 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39007,(0),null);
var map__39010 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39007,(1),null);
var map__39010__$1 = cljs.core.__destructure_map(map__39010);
var path = map__39010__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39010__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39010__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39010__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39010__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39010__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__39018 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39018,(0),null);
var map__39021 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39018,(1),null);
var map__39021__$1 = cljs.core.__destructure_map(map__39021);
var path = map__39021__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__39022 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__39023 = cljs.core.seq(vec__39022);
var first__39024 = cljs.core.first(seq__39023);
var seq__39023__$1 = cljs.core.next(seq__39023);
var r = first__39024;
var rnext = seq__39023__$1;
var rs = vec__39022;
...
var vec__39031 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39031,(0),null);
var map__39034 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39031,(1),null);
var map__39034__$1 = cljs.core.__destructure_map(map__39034);
var path = map__39034__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39034__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39034__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__39037 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39037,(0),null);
var map__39040 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39037,(1),null);
var map__39040__$1 = cljs.core.__destructure_map(map__39040);
var path = map__39040__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39040__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39040__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__39046 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39046,(0),null);
var map__39049 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39046,(1),null);
var map__39049__$1 = cljs.core.__destructure_map(map__39049);
var path = map__39049__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39049__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39049__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__39052 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39052,(0),null);
var map__39055 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39052,(1),null);
var map__39055__$1 = cljs.core.__destructure_map(map__39055);
var path = map__39055__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39055__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__39057 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39057,(0),null);
var map__39060 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39057,(1),null);
var map__39060__$1 = cljs.core.__destructure_map(map__39060);
var path = map__39060__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39060__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__39062 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39062,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39062,(1),null);
...
var len__5769__auto___39127 = arguments.length;
var i__5770__auto___39128 = (0);
while(true){
if((i__5770__auto___39128 < len__5769__auto___39127)){
args__5775__auto__.push((arguments[i__5770__auto___39128]));

var G__39130 = (i__5770__auto___39128 + (1));
i__5770__auto___39128 = G__39130;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq39066){
var G__39067 = cljs.core.first(seq39066);
var seq39066__$1 = cljs.core.next(seq39066);
var G__39068 = cljs.core.first(seq39066__$1);
var seq39066__$2 = cljs.core.next(seq39066__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39067,G__39068,seq39066__$2);
}));
...
var G__39148 = clojure.zip.rightmost(child);
loc__$1 = G__39148;
continue;
} else {
return loc__$1;
...
var vec__39092 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39092,(0),null);
var map__39095 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39092,(1),null);
var map__39095__$1 = cljs.core.__destructure_map(map__39095);
var path = map__39095__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39095__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39095__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39095__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39095__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__39157 = clojure.zip.rightmost(child);
loc__$1 = G__39157;
continue;
} else {
return loc__$1;
