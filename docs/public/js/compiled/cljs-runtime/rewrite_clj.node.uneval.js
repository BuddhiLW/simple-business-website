...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38352,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38352,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38362){
var vec__38363 = p__38362;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38363,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38363,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38351){
var self__ = this;
var G__38351__$1 = this;
return (new cljs.core.RecordIter((0),G__38351__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38353,other38354){
var self__ = this;
var this38353__$1 = this;
return (((!((other38354 == null)))) && ((((this38353__$1.constructor === other38354.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38353__$1.children,other38354.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38353__$1.__extmap,other38354.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38352){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38390 = k38352;
var G__38390__$1 = (((G__38390 instanceof cljs.core.Keyword))?G__38390.fqn:null);
switch (G__38390__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38352);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38351){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38395 = cljs.core.keyword_identical_QMARK_;
var expr__38396 = k__5352__auto__;
if(cljs.core.truth_((pred__38395.cljs$core$IFn$_invoke$arity$2 ? pred__38395.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38396) : pred__38395.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38396)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__38351,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38351),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38351){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__38351,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__38355){
var extmap__5385__auto__ = (function (){var G__38406 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38355,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__38355)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38406);
} else {
return G__38406;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38355),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__38423 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38423;
continue;
}
break;
