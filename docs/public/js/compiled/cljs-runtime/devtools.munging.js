...
var o28219 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28219["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28220 = temp__5802__auto____$1;
return (o28220["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27763__auto__ = f;
return (o__27763__auto__["toString"]).call(o__27763__auto__);
} else {
return "";
}
}catch (e28222){var _ = e28222;
return "";
}});
...
try{var o__27763__auto___28673 = t;
(o__27763__auto___28673["cljs$lang$ctorPrWriter"]).call(o__27763__auto___28673,t,writer);
}catch (e28243){var __28692 = e28243;
}
...
var char_code = (function (){var o__27763__auto__ = (new String(char$));
return (o__27763__auto__["charCodeAt"]).call(o__27763__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27763__auto__ = String;
return (o__27763__auto__["fromCharCode"]).call(o__27763__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28302 = num_code;
switch (G__28302) {
case (1):
return (185);
...
var o__27763__auto__ = String;
return (o__27763__auto__["fromCharCode"]).call(o__27763__auto__,superscript_code);
});
/**
...
}catch (e28338){var _e__27782__auto__ = e28338;
return false;
}})())){
...
var vec__28344 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28344,(0),null);
...
var len__5769__auto___28710 = arguments.length;
var i__5770__auto___28711 = (0);
while(true){
if((i__5770__auto___28711 < len__5769__auto___28710)){
args__5775__auto__.push((arguments[i__5770__auto___28711]));

var G__28712 = (i__5770__auto___28711 + (1));
i__5770__auto___28711 = G__28712;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28380){
var vec__28383 = p__28380;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28383,(0),null);
...
var G__28713 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28714 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28713;
remaining_tokens = G__28714;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28374){
var G__28375 = cljs.core.first(seq28374);
var seq28374__$1 = cljs.core.next(seq28374);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28375,seq28374__$1);
}));
...
var vec__28408 = cljs.core.split_with((function (p1__28405_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28405_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28408,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28408,(1),null);
...
var vec__28423 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28423,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28423,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28722 = cljs.core.rest(remaining_tokens);
var G__28723 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28722;
name_tokens = G__28723;
continue;
} else {
...
var vec__28439 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28439,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28439,(1),null);
var vec__28442 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(1),null);
var vec__28445 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(3),null);
...
var vec__28462 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28475 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(1),null);
var vec__28478 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28478,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28478,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28490 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28490) : devtools.munging.parse_fn_info_deep.call(null,G__28490));
})()));
}
} else {
return fn_info;
...
var G__28729 = (arity + (1));
var G__28730 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28512){
var vec__28513 = p__28512;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28513,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28513,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28525_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28525_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28526_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28526_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___28732 = arguments.length;
var i__5770__auto___28733 = (0);
while(true){
if((i__5770__auto___28733 < len__5769__auto___28732)){
args__5775__auto__.push((arguments[i__5770__auto___28733]));

var G__28734 = (i__5770__auto___28733 + (1));
i__5770__auto___28733 = G__28734;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28540){
var vec__28541 = p__28540;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28541,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28533){
var G__28534 = cljs.core.first(seq28533);
var seq28533__$1 = cljs.core.next(seq28533);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28534,seq28533__$1);
}));
...
var map__28576 = options;
var map__28576__$1 = cljs.core.__destructure_map(map__28576);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28577 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(5),null);
...
var o__27763__auto__ = f;
return (o__27763__auto__["getBasis"]).call(o__27763__auto__);
});
/**
...
}catch (e28592){var _e__27782__auto__ = e28592;
...
var G__28747 = (obj[cljs.core.first(path)]);
var G__28748 = cljs.core.rest(path);
obj = G__28747;
path = G__28748;
continue;
} else {
...
var _STAR_ = (function (accum,p__28626){
var vec__28627 = p__28626;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28627,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28627,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28643){
var vec__28646 = p__28643;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28646,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28646,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28646,(2),null);
...
var post_process = (function (p__28655){
var vec__28656 = p__28655;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28652_SHARP_){
return (obj[cljs.core.first(p1__28652_SHARP_)]);
}),sorted_matches);
